/***************************************************************************\
  File: IMR_DirectX.cpp
  Description: DirectX wrapper class.
...
if (err != DD_OK)
    {
    IMR_SetErrorText("IMR_DirectXInterface::Init(): 1 DXERR: %s", IMR_MsgFromDXErr(err));
    Shutdown(); return IMRERR_DIRECTX;
     }
err = DirectDraw1->QueryInterface(IID_IDirectDraw4, (void **)&DirectDraw);
if (err != DD_OK)
    {
    IMR_SetErrorText("IMR_DirectXInterface::Init(): 2 DXERR: %s", IMR_MsgFromDXErr(err));
    Shutdown(); return IMRERR_DIRECTX;
     }
...
if (err != DD_OK)
    {
    IMR_SetErrorText("IMR_DirectXInterface::Init(): 3 DXERR: %s", IMR_MsgFromDXErr(err));
    Shutdown(); return IMRERR_DIRECTX;
     }
...
if (err != DD_OK)
    {
    IMR_SetErrorText("IMR_DirectXInterface::Init(): Display mode not supported!", IMR_MsgFromDXErr(err));
    Shutdown(); return IMRERR_DIRECTX;
     }
...
if (err != DD_OK)
    {
    IMR_SetErrorText("IMR_DirectXInterface::Init(): 5 DXERR: %s", IMR_MsgFromDXErr(err));
    Shutdown(); return IMRERR_DIRECTX;
     }
...
if (err != DD_OK)
    {
    IMR_SetErrorText("IMR_DirectXInterface::Init(): 6 DXERR: %s", IMR_MsgFromDXErr(err));
    Shutdown(); return IMRERR_DIRECTX;
     }
...
if (err != DD_OK)
    {
    IMR_SetErrorText("IMR_DirectXInterface::Create_Surface(): DXERR: %s", IMR_MsgFromDXErr(err));
    return NULL;
     }
...
if (err != DD_OK)
    {
    IMR_SetErrorText("IMR_DirectXInterface::Create_Texture(): 1 DXERR: %s", IMR_MsgFromDXErr(err));
    return NULL;
     }
...
if (err != DD_OK)
    {
    IMR_SetErrorText("IMR_DirectXInterface::Create_3DSurface(): DXERR: %s", IMR_MsgFromDXErr(err));
    return NULL;
     }
