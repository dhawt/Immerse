...
if (!Pal)
    {
    IMR_LogMsg(__LINE__, __FILE__, "IMR_PaletteInfo::SetPalette(): No palette specified!");
...
if (!(LightTable = new char [8192]) ||
    ...
    {
    IMR_LogMsg(__LINE__, __FILE__, "IMR_PaletteInfo::SetPalette(): Out of memory! (Tabl)");
